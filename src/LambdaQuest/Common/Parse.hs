...
import Text.Parsec
import Text.Parsec.Token as PT hiding (naturalOrFloat)
import Data.Foldable (foldl')
import Data.Char (digitToInt)
import Data.Ratio

{-
Since Parsec's 'naturalOrFloat' doesn't support hexadecimal floats, I've written one.
...
The syntax for numbers here differs from C11's in the following ways:
 ...
 - decimal-floating-constant without digits before '.' are not allowed.

'natFloat' is a version that doesn't skip trailing whitespaces. It may be used to build a parser for imaginary numbers.
-}
...
makeDecimal, makeHexadecimal :: Fractional r => Integer -> [Char] -> Int -> r
makeDecimal = makeFractional 10 1
makeHexadecimal = makeFractional 2 4
{-
  123.45e+6 == makeDecimal 123 "45" 6
  0xdead.beefp-4 == makeHexadecimal 0xdead "beef" (-4)
-}
